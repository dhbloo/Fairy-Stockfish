...
enum Value : int {
  ...
  RookValueMg   = 1344,  RookValueEg   = 1386,
  QueenValueMg  = 2538,  QueenValueEg  = 2682,
  FersValueMg              = 208,   FersValueEg              = 132,
  ...
  CannonPieceValueMg       = 560,   CannonPieceValueEg       = 627,
  JanggiCannonPieceValueMg = 800,   JanggiCannonPieceValueEg = 600,
  SoldierValueMg           = 167,   SoldierValueEg           = 263,
  HorseValueMg             = 433,   HorseValueEg             = 630,
  ElephantValueMg          = 240,   ElephantValueEg          = 281,
