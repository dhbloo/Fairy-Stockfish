...
enum Value : int {
  ...
  RookValueMg   = 1441,  RookValueEg   = 1744,
  QueenValueMg  = 2538,  QueenValueEg  = 2682,
  FersValueMg              = 195,   FersValueEg              = 123,
  ...
  CannonPieceValueMg       = 498,   CannonPieceValueEg       = 580,
  JanggiCannonPieceValueMg = 800,   JanggiCannonPieceValueEg = 600,
  SoldierValueMg           = 157,   SoldierValueEg           = 269,
  HorseValueMg             = 450,   HorseValueEg             = 707,
  ElephantValueMg          = 224,   ElephantValueEg          = 217,
